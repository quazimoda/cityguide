...
export type Article = { title: string; slug: string; excerpt: string; category: string; publishedDate: string; readingTime: string; tags: string[]; heroImage: string; sections: ContentSection[]; seoDescription: string };
