          ...
          <div className="w-full max-w-xl rounded-3xl bg-white p-6 shadow-xl">
            ...
            <form onSubmit={submit} className="mt-5 grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2 flex flex-wrap items-center gap-3">
                <button disabled={isSubmitting || hasSubmitted} className="rounded-xl bg-teal-700 px-5 py-3 font-bold text-white disabled:cursor-not-allowed disabled:opacity-60">{isSubmitting ? 'Sending…' : hasSubmitted ? 'Request sent' : 'Send request'}</button>
